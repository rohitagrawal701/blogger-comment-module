...
public class CascadingMongoEventListener
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(CascadingMongoEventListener.class);
    ...
    @Override
    public void onBeforeDelete(final BeforeDeleteEvent<Object> event) {
    ...
    public void onBeforeSave(final BeforeSaveEvent<Object> event) {
        ...
        // final Field[] fields =
        // event.getSource().getClass().getDeclaredFields();
        ...
        // fieldValue.getClass().getMethod("set"+event.getSource().getClass().getSimpleName(),
        // List.class);
        // final Method getterMethod =
        // fieldValue.getClass().getMethod("get"+event.getSource().getClass().getSimpleName(),
        // null);
        // if (getterMethod.invoke(fieldValue, null) != null) {
        // ((List<Object>) getterMethod.invoke(fieldValue,
        // null)).add(event.getSource());
        // } else {
    ...
    @Override
    public void onAfterDelete(final AfterDeleteEvent<Object> event) {
