...
public class ResourceBundleUtil {
    ...
    private static final Logger LOGGER =
            Logger.getLogger(ResourceBundleUtil.class);
     ...
     * @return value
     */
    public static String getLocalizedMessage(final Class<?> clazz,
        ...
        final ResourceBundle bundle =
                ResourceBundle.getBundle(clazz.getName(), localeToUse);
     ...
     * @return value
     */
    public static String getLocalizedMessage(final String properties,
            final String key, final Locale locale) {
        Locale localeToUse = locale;
        if (localeToUse == null) {
     ...
     * @return
     */
    public static String getKey(final Class<?> clazz, final String message,
            final Locale locale) {
        Locale localeToUse = locale;
        if (localeToUse == null) {
            localeToUse = Locale.getDefault();
     ...
     * @return
     */
    public static List<String> getKeys(final Class<?> clazz,
