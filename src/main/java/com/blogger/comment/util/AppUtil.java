package com.blogger.comment.util;
...
public class AppUtil {
     ...
     *
     * @param object object to convert in json format
     ...
     *
     * @param jsonValue JSON string to convert into object
     * @param className Class name in which object need to be convert
     * @return Converted Object
     * @throws IOException
     */
    public static Object convertJsonToObjec(final String jsonValue,
            final Class<?> className) throws IOException {
        final ObjectMapper mapper = new ObjectMapper();
        mapper.setSerializationInclusion(JsonInclude.Include.NON_NULL);
     ...
     * @param object Date object to be formated
     * @return
     * @throws ParseException
     */
    public static Calendar convertStringToCalender(final String format,
            final Object object) throws ParseException {
        if (object == null) {
     ...
     *
     * @param format Date format
     * @param object Objcet to be converted
     * @return
     * @throws ParseException
     */
    public static String convertCalenderToString(final String format,
            final Calendar object) throws ParseException {
        if (object == null) {
            return null;
        } else {
            final DateFormat df = new SimpleDateFormat(format);
     ...
     *
     * @param collection Collection to be checked for EMPTY
     * @return true | false
     */
     ...
     *
     * @param value Double to be validated
     * @return true|false
     */
    ...
    public static Date convertStringToDate(final String format,
     ...
     *
     * @param locale Respective Locale of String.
     * @return
     */
     ...
     */
    public static String convertDateToString(final String string,
            final Date time) {
