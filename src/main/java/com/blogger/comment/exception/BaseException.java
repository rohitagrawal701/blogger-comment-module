package com.blogger.comment.exception;
...
public class BaseException extends Exception {
     ...
     *
     * @param message The error message
     * @param args Arguments for error messages variable .
     */
     ...
     * exception.
     *
     * @param message Error message for specific error.
     * @param exception Actual exception Thrown by code.
     */
